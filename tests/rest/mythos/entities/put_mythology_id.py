...
class TestMythology:
    ...
    def test_f_update_mythology_by_id(self):
        ...
        with allure.step(
            "Шаг: создаем сущность и присваиваем значение переменной response"
        ):
    ...
    def test_f_update_mythology_by_id_with_fixtures(
        self, auth_user_tuco, mythology_id_by_user_tuco
    ):
        with allure.step("Шаг: Обновить сущность"):
            update_response = fully_update_mythology_by_id(
                auth_user_tuco, mythology_id_by_user_tuco, name="stone"
            )
